          ...
          <div className="flex items-center justify-between py-1.5 px-4">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-xs text-orange-400/70 truncate">
                — Install: <code className="bg-orange-500/20 px-1 rounded">brew install kubestellar/tap/kkc-agent</code> → run <code className="bg-orange-500/20 px-1 rounded">kkc-agent</code> → configure API keys in Setup
              </span>
            </div>
